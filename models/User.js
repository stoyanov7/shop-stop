...
let userSchema = mongoose.Schema({
     username: {
          ...
          require: propertyIsRequired.replace('{0}', 'Username'),
          unique: true
     },
     password: {
          type: mongoose.Schema.Types.String,
          require: propertyIsRequired.replace('{0}', 'Password')
     },
     salt: {
          type: mongoose.Schema.Types.String,
          require: true
     ...
     firstName: {
          type: mongoose.Schema.Types.String,
          require: propertyIsRequired.replace('{0}', 'First name')
     },
     lastName: {
          type: mongoose.Schema.Types.String,
          require: propertyIsRequired.replace('{0}', 'Last name')
     },
     age: {
